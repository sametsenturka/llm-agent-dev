...
- Built by a freshman as a learning project.
- Special thanks to the **Phidata framework** for enabling the development of intelligent agents.

---

For questions or issues, please open an issue on the [GitHub repository](https://github.com/sametsenturka/llm-agent-dev/issues).
```
